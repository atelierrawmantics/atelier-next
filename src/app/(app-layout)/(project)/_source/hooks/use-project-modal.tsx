...
const FORM_FIELDS = [
  {
    ...
    label: '프로젝트명',
    placeholder: '프로젝트명을 입력해 주세요 (최대 30자)',
    maxLength: 30,
    component: Input,
    isRequired: true,
  },
  {
    ...
    label: '프로젝트 설명',
    placeholder: '프로젝트에 대한 설명을 입력해 주세요 (최대 500자)',
    maxLength: 500,
    component: Textarea,
    className: 'h-[200px]',
    isRequired: true,
  },
  {
    ...
    label: '고객사명',
    placeholder: '고객사명을 입력해 주세요 (최대 30자)',
    maxLength: 30,
    component: Input,
    isRequired: false,
  },
  {
    ...
    label: '고객사 설명',
    placeholder: '고객사에 대한 설명을 입력해 주세요 (최대 500자)',
    maxLength: 500,
    component: Textarea,
    className: 'h-[200px]',
    isRequired: false,
      ...
      <AlertDialogContent className="rounded-none min-w-screen sm:rounded-[12px] sm:min-w-[600px] w-screen sm:max-h-[800px] h-screen">
        ...
        {status === 'create' && (
          <AlertDialogDescription className="py-[10px] px-[20px] bg-primary-1 flex gap-[6px] items-center sm:items-start border-t border-b border-border-basic-1">
            <InfoFillIcon className="size-[20px] text-primary-3" />
