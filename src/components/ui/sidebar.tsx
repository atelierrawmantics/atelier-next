...
import { CaretDoubleRightIcon } from '@/generated/icons/MyIcons'
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
          side === 'left' ?
  ...
  return (
    ...
    >
      <CaretDoubleRightIcon
        className={cn('size-[16px]', open && 'rotate-180')}
      />
...
function SidebarMenu({ className, ...props }: React.ComponentProps<'ul'>) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn('flex w-full min-w-[60px] flex-col', className)}
      {...props}
    />
  )
}
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<'li'>) {
  return (
    <li
      ...
      className={cn(
        'group/menu-item relative min-h-[52px] h-full flex flex-1',
        className,
      )}
      {...props}
    />
